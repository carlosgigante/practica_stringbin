<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::hidden('id_user', Auth::user()->id , $cuentabanco->id_user, ['class' => 'form-control' . ($errors->has('id_user') ? ' is-invalid' : ''), 'placeholder' => 'Id User']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::select('tipo_cuenta',['Ahorro' => 'Ahorro', 'Corriente' => 'Corriente'],  $cuentabanco->tipo_cuenta, ['class' => 'form-control' . ($errors->has('tipo_cuenta') ? ' is-invalid' : ''), 'placeholder' => 'Tipo Cuenta']) }}
